...
def upgrade() -> None:
    ...
    op.create_index('ix_metagraph_history_updated_at', 'metagraph_history', ['updated_at'])
    op.create_index('ix_metagraph_history_neuron_uid', 'metagraph_history', ['neuron_uid'])


def downgrade() -> None:
    op.drop_index('ix_metagraph_history_neuron_uid', table_name='metagraph_history')
    op.drop_index('ix_metagraph_history_updated_at', table_name='metagraph_history')
