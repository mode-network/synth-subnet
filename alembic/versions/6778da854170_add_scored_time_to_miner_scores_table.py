...
def upgrade() -> None:
    op.add_column('miner_scores', sa.Column('scored_time', sa.DateTime(timezone=True), nullable=True))
    op.create_index('ix_miner_scores_scored_time', 'miner_scores', ['scored_time'])
