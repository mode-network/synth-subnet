...
class TestPriceDataProvider(unittest.TestCase):
    ...
    def test_fetch_data_all_prices(self):
        ...
        mock_response = {
            "t": [1739974320, 1739974380, 1739974440, 1739974500, 1739974560, 1739974620, 1739974680],
            "c": [100000.23, 101000.55, 99000.55, 102000.55, 103000.55, 105000.55, 108000.867],
        }
    ...
    def test_fetch_data_gap_3(self):
        ...
        mock_response = {
            "t": [1739974320, 1739974680, 1739974740, 1739974800, 1739974860, 1739974920],
            "c": [100000.23, 108000.867, 99000.23, 97123.55, 105123.345, 107995.889],
        }
    ...
    def test_fetch_data_gap_from_start_2(self):
        ...
        # 1739974920 - 2025-02-20T14:22:00+00:00
        mock_response = {
            "t": [1739974380, 1739974440, 1739974500, 1739974560, 1739974620, 1739974680, 1739974740, 1739974800, 1739974860, 1739974920],
            "c": [101000.55, 99000.55, 102000.55, 103000.55, 105000.55, 108000.867, 99000.23, 97123.55, 105123.345, 107995.889],
        }
    ...
    def test_fetch_data_gap_in_the_middle(self):
        ...
        mock_response = {
            "t": [1739974320, 1739974380, 1739974440, 1739974500, 1739974560, 1739974680, 1739974740, 1739974800, 1739974860, 1739974920, 1739974980],
            "c": [100000.23, 101000.55, 99000.55, 102000.55, 103000.55, 108000.867, 108000.867, 99000.23, 97123.55, 105123.345, 107995.889],
        }
    ...
    def test_fetch_data_several_values(self):
        ...
        # 1739974980 - 2025-02-20T14:23:00+00:00
        mock_response = {
            "t": [1739974320, 1739974380, 1739974440, 1739974500, 1739974560, 1739974620, 1739974680, 1739974740, 1739974800, 1739974860, 1739974920, 1739974980],
            "c": [100000.23, 101000.55, 99000.55, 102000.55, 103000.55, 105000.55, 108000.867, 108000.867, 99000.23, 97123.55, 105123.345, 107995.889],
        }
