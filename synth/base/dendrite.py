...
class DendriteMixin:
    ...
    def log_exception(self, exception: Exception):
        ...
        if isinstance(
            exception, (aiohttp.ClientOSError, asyncio.TimeoutError)
        ):
    ...
    def process_error_message(
        ...
        error_info = DENDRITE_ERROR_MAPPING.get(
            type(exception), DENDRITE_DEFAULT_ERROR
        )
...
BaseModel: Union["torch.nn.Module", object] = (
    torch.nn.Module if use_torch() else object
)
